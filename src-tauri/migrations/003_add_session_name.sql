-- Add custom name column to sessions.
...
INSERT INTO sessions_new (
    id, project_id, name, protocol, role, status, bind_addr, target_url,
    local_addr, remote_addr, created_at, updated_at
)
SELECT
    id, project_id, NULL, protocol, role, status, bind_addr, target_url,
    local_addr, remote_addr, created_at, updated_at
FROM sessions;
